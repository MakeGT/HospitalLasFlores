"""LasFloresHospital URL Configuration
...
urlpatterns = [
    ...
    url(r'^$', login, {'template_name':'usuarios/index.html'}, name = 'login'),
    url(r'^reset/password_reset', password_reset, {'template_name':'registro/password_reset_form.html', 
    'email_template_name':'registro/password_reset_email.html'}, name= 'password_reset' ),
    url(r'^reset/password_reset_done', password_reset_done,{'template_name':'registro/password_reset_done.html'},
    name='password_reset_done'),
    url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>.+)/$', password_reset_confirm, {'template_name': 'registro/password_reset_confirm.html'}, 
